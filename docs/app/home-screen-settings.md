...
Add or disable banners here — see the full [Banners guide](/docs/admin/other-pages#banners) for field details.
...
To change what appears here, edit the properties/rooms themselves — see the [Property Management guide](/docs/admin/property-management).
...
See the full [Events & Inquiries guide](/docs/admin/events-and-inquiries) for adding and managing events.
